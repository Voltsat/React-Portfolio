...
export default
  ...
  return (
    <section id='home' className="z-10 mx-4 flex flex-col text-center min-h-screen justify-center relative motion-scale-in-[0.25] motion-blur-in-[10px] motion-delay-[0.25s]/blur motion-ease-linear">
      ...
      <p className="text-neutral-300 text-sm md:text-lg w-96 md:w-[768px] max-w-full mx-auto">Building products that matter. I am a Mobile Developer dedicated to designing and implementing high-performance, scalable systems that solve complex business challenges.</p>
      <div className="flex justify-center space-x-6 mb-8 text-zinc-300 mt-4">
        ...
        <a href="mailto:dhabitmuhammadfaqih@gmail.com" aria-label="Send me an email" className=" p-[6px] rounded-md hover:text-white  transition-colors duration-300">
          <Mail size={24} />
        </a>
      </div>
      <div className="flex justify-center space-x-8 mb-8">
        <Magnet padding={12} magnetStrength={4}>
