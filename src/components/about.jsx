          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left px-4 md:px-8 py-4">
            <div className='flex items-center w-full'>
              <div className="flex items-center space-x-6 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-white p-2 bg-gray-500 border-2 border-white/20 rounded-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
